...
// fixture renders `'Submitted!'` (WITH bang per tests/fixture-app/index.html:13), and
...
test('clicks submit button and sees assertion confirmation', async ({ page }) => {
  ...
  // ASSERTION BUG: actual rendered text per tests/fixture-app/index.html:13 is "Submitted!"
